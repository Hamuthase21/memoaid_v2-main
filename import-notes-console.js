/**
 * Simple script to add sample notes to localStorage
 * Run this in the browser console to populate the app with sample notes
 */
...
function importSampleNotes() {
    try {
        ...
        console.log(`✅ Successfully imported ${importedCount} sample notes!`);
